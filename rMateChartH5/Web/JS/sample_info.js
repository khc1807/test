...
var sampleBaseURL = "./Samples/",
	...
	// Pie
		"n":"Pie", "c":[
			...
			{"n":"Dual Pie Chart", "u":"Click_Pie2D_CreateChart"}
		]
	},{
	// Bubble
		"n":"Bubble", "c":[
			{"n":"Bubble", "u":"Bubble_2D"},
	...
	// 목표대비실적
		"n":"Target vs Actual", "c":[
			...
			{"n":"Linear 2D Color", "u":"Target_2D_Color"},
			{"n":"Linear 2D Overlaid", "u":"Target_2D_Overlaid"},
			{"n":"Dash Dot", "u":"Target_2D_DashDot"}
		]
	},{
	// History
		"n":"History", "c":[
	...
	// Lollipop
		"n":"Lollipop", "c":[
			{"n":"Lollipop", "u":"Lollipop_Single"},
			{"n":"Lollipop Multi", "u":"Lollipop_MS"}
			//{"n":"Lollipop Overlaid", "u":"Lollipop_Overlaid"}
		]
	},{
	// Image
		"n":"Image", "c":[
	...
	// Candlestick
		"n":"Candlestick", "c":[
			...
			{"n":"Candlestick Symbol (2)", "u":"Candlestick_Symbol_Another"},
	...
	// Bump
		"n":"Bump", "c":[
			{"n":"Bump Segment", "u":"Bump_2D_Segment"},
			{"n":"Bump Curve", "u":"Bump_2D_Curve"},
			{"n":"Bump ItemRenderer", "u":"Bump_2D_ItemRenderer"}
		]
	},{
	// WordCloud
		"n":"WordCloud", "c":[
	...
	// ErrorBar
		"n":"ErrorBar", "c":[
			...
			{"n":"Combination ErrorBar", "u":"Error_Combination"}
		]
	},{
	// BoxPlot
		"n":"BoxPlot", "c":[
	...
	properties = [{
			"n":"데이터 생성 및 연동방식", "c":[
				...
				{"n":"JSON 레이아웃 배열 데이터", "u":"Embeding_JSON_Array"},
			...
			"n":"선/범위/배경", "c":[
				...
				{"n":"특정 부분에 화살표 선 긋기", "u":"Axis_Part_Line"},
				{"n":"축에 범위 넣기", "u":"Axis_Area"},
				{"n":"축에 다수의 범위 넣기", "u":"Axis_Multi_Area"},
				{"n":"특정 부분에 범위 넣기", "u":"Axis_Part_Area"},
			...
			"n":"축 라벨 설정", "c":[
				...
				{"n":"X축 라벨 회전하여 출력", "u":"EmbededFont_XLabel"},
				...
				{"n":"라벨 지그재그 출력", "u":"LabelField_CanStagger"},
				{"n":"라벨 겹침 방지", "u":"LabelField_CanDropLabels"},
				{"n":"그룹핑 라벨 출력", "u":"LabelField_Group"},
				{"n":"X축 라벨 자동 개행처리", "u":"Label_X_AutoLineBreak"},
				{"n":"Y축 라벨 자동 개행처리", "u":"Label_Y_AutoLineBreak"}
				//{"n":"CategoryAxis사용시 <br>많아진 라벨의 처리", "u":"CategoryAxis_CanDropLabels"}
			]
		},{
			"n":"시리즈 수치표시", "c":[
				{"n":"컬럼 외부에 수치표시", "u":"LabelField_Column_Outside"},
				{"n":"컬럼 내부에 수치표시", "u":"LabelField_Column_Inside"},
				...
				{"n":"라인 상단에 수치표시", "u":"LabelField_Line_2D_Up"},
				{"n":"라인 하단에 수치표시", "u":"LabelField_Line_2D_Down"},
				{"n":"플롯 차트 겹치는 라벨 자르기", "u":"LabelField_Plot_DropLabels"},
				//{"n":"영역 차트 상단에 수치표시", "u":"LabelField_Area_2D_Up"},
				//{"n":"영역 차트 하단에 수치표시", "u":"LabelField_Area_2D_Down"},
				{"n":"파이 내부에 표시", "u":"LabelField_Pie"},
				{"n":"파이 외부에 표시", "u":"LabelField_Pie_Callout"},
				{"n":"파이 내부/외부에 표시", "u":"LabelField_Pie_insideWithCallout"},
				{"n":"레이더 차트 수치표시", "u":"Radar_Label"},
				{"n":"수치에 소수점 지정", "u":"LabelField_NumberFormatter"},
			...
			"n":"시리즈 디자인", "c":[
				...
				{"n":"컬럼 그라데이션 컬러", "u":"Column_2D_Gradient_Fill"},
				...
				{"n":"컬럼 차트 조건별 테두리 색상 결정하기", "u":"Column_2D_Custom_Stroke"},
				{"n":"라인 차트 조건별 아이템 렌더러 결정하기", "u":"Line_2D_Custom_ItemRenderer"},
			]
		},{
			"n":"추세선 표시", "c":[
			...
			"n":"데이터팁(툴팁)", "c":[
				...
				{"n":"데이터 팁 소수점 지정", "u":"DataTip_NumberFormatter"},
				{"n":"데이터 팁 사용자 정의", "u":"DataTip_Func"},
				{"n":"데이터 팁 사용자 정의<br>(파이계열)", "u":"DataTip_Func2"},
				{"n":"축 데이터 팁 사용자 정의", "u":"DataTip_Axis_Func"}
			]
		},{
			"n":"이펙트", "c":[
			...
			"n":"범례", "c":[
				...
				{"n":"범례 클릭하여 강조", "u":"Legend_ItemEmphasize"},
				{"n":"범례에 스크롤 생성하기", "u":"Legend_Over"},
				{"n":"SubLegend 선택/해제", "u":"Legend_Sub_CheckBox"},
				{"n":"SubLegend ItemRenderer", "u":"Legend_Sub_ItemRenderer"},
			...
			"n":"확대/축소", "c":[
				{"n":"라인 차트 확대/축소 (y축 고정)", "u":"Zoom_Line_Fix"},
				{"n":"라인 차트 확대/축소 (y축 가변)", "u":"Zoom_Line_Flexible"},
				{"n":"컬럼 차트 확대/축소", "u":"Zoom_Column"},
				{"n":"바 차트 확대/축소", "u":"Zoom_Bar"},
				{"n":"영역 차트 확대/축소", "u":"Zoom_Area"},
				{"n":"버블 차트 확대/축소", "u":"Zoom_Bubble"},
				{"n":"플롯 차트 확대/축소", "u":"Zoom_Plot"},
				{"n":"콤비네이션 차트 확대/축소", "u":"Zoom_Combination"}
			...
			"n":"리액트,뷰 샘플", "c":[
				{"n":"리액트 샘플", "u":"React_Vue_Angular_Build/ReactWeb/index"},
				{"n":"뷰 샘플", "u":"React_Vue_Angular_Build/VueWeb/index"}
			]
		},{
			"n":"Setter/Getter 활용 샘플", "c":[
				{"n":"Column V축 Min/Max 변경", "u":"SetterGetter_Axis_MinMax"},
				{"n":"Column 두께 변경", "u":"SetterGetter_Series_ColumnWidth"},
				{"n":"Column 타입 변경", "u":"SetterGetter_Series_Type"},
				{"n":"Column 색상 변경", "u":"SetterGetter_Series_Fills"},
				{"n":"Bar 라벨위치 변경", "u":"SetterGetter_Series_LabelPosition"},
				{"n":"Bar Inside라벨 정렬 변경", "u":"SetterGetter_Series_LabelAlign"},
				{"n":"Line ItemRenderer 변경", "u":"SetterGetter_Series_ItemRenderer"},
				{"n":"Line Form 변경", "u":"SetterGetter_Series_Form"},
				{"n":"Area FillStroke 변경", "u":"SetterGetter_Series_FillStroke"},
				{"n":"Pie LabelField 변경", "u":"SetterGetter_Series_LabelField"},
				{"n":"Radar Field 변경", "u":"SetterGetter_Series_Field"},
				{"n":"축 위치 변경", "u":"SetterGetter_Axis_Placement"},
				{"n":"축 라벨 Visible", "u":"SetterGetter_Axis_LabelVisible"},
				{"n":"배경 축선 위치", "u":"SetterGetter_Bg_TargetLine"},
				{"n":"전경 메모 위치", "u":"SetterGetter_An_MemoLoc"},
				{"n":"차트 생성 후 스크롤이동", "u":"SetterGetter_Axis_ScrollPosition"},
			]
		},{
			"n":"기타 기능", "c":[
				{"n":"버튼 클릭으로 리사이즈", "u":"Resize_UserEvent"},
				{"n":"프리로더 보이기, 숨기기", "u":"ShowAndHidePreloader"},
				{"n":"데이터가 없을경우", "u":"No_Data_Func"},
				{"n":"차트 데이터 CSV 저장", "u":"SaveData_CSV"},
				{"n":"컨텍스트 메뉴 출력하지 않기", "u":"ContextMenu_Disabled"}
			]
		}
	];
